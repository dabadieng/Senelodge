 ...
 * @UniqueEntity(
 *      fields={"email"},
 *      message="Un autre utilisateur utilise déja cet email. Merci de la modifier"
 * )
 */
class User implements UserInterface
{
     ...
     *@Assert\EqualTo(propertyPath="hash", message="Vous n'avez pas correctement  confimé votre mot de passe")
     */
    public $passwordConfirm;

    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=10, minMessage="Votre introduction doit contenir plus de 10 caractères")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Votre descriotion doit contenir au minimun 100 caractères")
     */
    private $description;
    ...
    {
        /**
         * Permet de boucler sur chaque objet role de la collecton userRoles
         * afin de construire un tableau indicé de type php 
         */
        $roles = $this->userRoles->map(function ($role) {
            return $role->getTitle();
        })->toArray();

        $roles[] = "ROLE_USER_NOT_CONFIRM";
